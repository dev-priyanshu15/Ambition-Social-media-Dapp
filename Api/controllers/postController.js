...
const createPostController = async (req, res, next) => {
  const { userId, caption, fileURL, title, image, tokenId, txHash, address } =
    req.body;
  try {
...
const createPostWithImagesController = async (req, res, next) => {
  ...
  console.log(userId, caption, fileURL);
...
const getPostsController = async (req, res, next) => {
  ...
  try {
    ...
    }).populate("user", "username fullName profilePicture verify");
